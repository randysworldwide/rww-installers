...
# Pulls the current version of VSCWinTerminalInst.ps1 from the public
...
$branch    = 'main'
$repoPath  = 'Scripts/VSCWinTerminalInst.ps1'
$localPath = "$env:ProgramData\Dev\Scripts\VSCWinTerminalInst.ps1"
...
try {
    ...
    [Console]::WriteLine("[BOOTSTRAP] [ERROR] Failed to download install script from GitHub: $($_.Exception.Message)")
    exit 5
}
