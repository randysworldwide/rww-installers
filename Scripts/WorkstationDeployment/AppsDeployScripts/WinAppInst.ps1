...
.DESCRIPTION
    ...
    Files are staged in C:\ProgramData\Dev\AppsDeploy\WindowsApp (Dev is a hidden
...
[CmdletBinding()]
param(
    [string]$LogPath = "$env:ProgramData\Dev\AppsDeploy\Logs\WinAppInst.log"
)

$ErrorActionPreference = 'Stop'

$DestDir     = "$env:ProgramData\Dev\AppsDeploy\WindowsApp"
